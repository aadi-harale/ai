...
export default function Home(){
  return <main className="landing">
    ...
    <section className="section" id="innovation"><span className="kicker">THE FEATURE TO SELL</span><h2>Don’t just choose the best site. Design it.</h2><div className="innovation"><Wrench/><div><span>SITE VIABILITY UPGRADE PLANNER</span><h3>Site C is safer — but healthcare is the bottleneck.</h3><p>In the seeded demo, the health package raises healthcare capacity from 540 to 870 people, but functional carrying capacity only rises from 540 to 690 because water becomes the next weakest service. SafeShift exposes that second-order bottleneck instead of pretending one upgrade solves the site.</p></div></div></section>
